...
namespace Dominion.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DominionContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,UserName,FirstName,LastName,OrgID,AuthLevel")] Users users)
        {
            if (id != users.UserID)
            {
                return NotFound();
