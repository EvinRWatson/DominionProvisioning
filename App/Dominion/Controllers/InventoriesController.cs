...
namespace Dominion.Controllers
{
    ...
    public class InventoriesController : Controller
    {
        ...
        public InventoriesController(DominionContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockID,ItemName,Quantity,OrgID")] Inventory inventory)
        {
